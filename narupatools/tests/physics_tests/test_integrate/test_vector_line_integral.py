...
from narupatools.physics.integrate import vector_line_integral
...
def test_shape():
    ...
    integral = vector_line_integral(integrand, x)
...
def test_axis_shape():
    ...
    integral = vector_line_integral(integrand, x, axis=-2)
    assert integral.shape == (grouped,)
