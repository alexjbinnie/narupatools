...
These protocols provide this methods as abstract methods, ensuring that if you include
them in your class hierarchy then you have to implement them correctly.
"""
