...
def calculate_residue_entities(*, residue_count: int, particle_residues: np.ndarray,
                               bond_pairs: np.ndarray) -> np.ndarray:
    """
    ...
    return np.unique(entities, return_inverse=True)[1]
