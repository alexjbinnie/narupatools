...
class NoseHooverIntegrator(Integrator):
    ...
    def getCollisionFrequency(self, chainID: int = 0) -> float: ...
    def getMaximumPairDistance(self) -> float: ...
    def getNumThermostats(self) -> int: ...
    def getRelativeCollisionFrequency(self, chainID: int = 0) -> float: ...
    def getRelativeTemperature(self, chainID: int = 0) -> float: ...
    def getTemperature(self, chainID: int = 0) -> float: ...
    def getThermostat(self, chainID: int = 0) -> NoseHooverChain: ...
    def hasSubsystemThermostats(self) -> bool: ...
    def setCollisionFrequency(self, frequency: float, chainID: int = 0) -> None: ...
    def setMaximumPairDistance(self, distance) -> None: ...
    def setRelativeCollisionFrequency(
        self, frequency: float, chainID: int = 0
    ) -> None: ...
    def setRelativeTemperature(self, temperature: float, chainID: int = 0) -> None: ...
    def setTemperature(self, temperature: float, chainID: int = 0) -> None: ...
...
class LocalEnergyMinimizer:
    ...
    @staticmethod
    def minimize(
        context: Context, tolerance: float = 10, maxIterations: int = 0
    ) -> None: ...
